...
const Signup = ({handleClose}) => {
  ...
  return (
    <div>
        <Box p={3} style={{display:"flex" , flexDirection:"column" ,gap:"20px" ,margin:"10px"}}>
            ...
            <Button variant='contained' size='large' style={{backgroundColor:"gold"}} onClick={handleSubmit}>Sign Up</Button>
        </Box>
    </div>
  )
}
